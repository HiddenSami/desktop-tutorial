...
def capture_image(filename='/Users/themysteriousone/Desktop/hgp-vision-main/image.jpg'):
...
def analyze_image(image_path):
    ...
    headers = {
        'Authorization': 'Bearer sk-proj-UwlhGmrB2BzdYYGOtn06T3BlbkFJntkEzWvzqaVOOFeXefCi',  # Correctly format the API key
